...
public class ServiceUtils extends BaseModule {
    ...
    public static ComponentTwoService provideCommonService() {
        String wfKey = ComponentTwoService.class.getName() + BASE_PATH;
        ComponentTwoService service = BaseModule.getReferenceInstance(wfKey);
        if (service == null) {
            service = new Retrofit.Builder()
                    ...
                    .client(okClient)
                    .build()
                    .create(ComponentTwoService.class);
